import{l as h,i as u,g as S}from"./assets/footer-2300bbd7.js";import{a as g,P as D}from"./assets/vendor-d873ffc3.js";function I(t){const e=t.map(s=>`<li class="filters-categories-item">${s}</li>`);document.querySelector(".filters-categories-list").insertAdjacentHTML("beforeend",e.join("").replaceAll("_"," "))}function T(t){const e=this.closest(".filters-wrap"),s=e.querySelector(".filters-down-svg"),a=e.querySelector("ul");a.classList.contains("list-active")?a.classList.remove("list-active"):a.classList.add("list-active"),s.classList.contains("rotate")?s.classList.remove("rotate"):s.classList.add("rotate")}function z(t){this.classList.contains("rotate")?this.classList.remove("rotate"):this.classList.add("rotate"),this.previousElementSibling.classList.contains("list-active")?this.previousElementSibling.classList.remove("list-active"):this.previousElementSibling.classList.add("list-active")}function H(t){const e=document.querySelector(".filters-categories"),s=document.querySelector(".filters-categories-list"),a=t.target.textContent;e.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate")}function _(t){const e=document.querySelector(".filters-allTypes"),s=document.querySelector(".filters-allTypes-list"),a=t.target.textContent;e.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate")}function C(){const t=document.querySelector(".filters-allTypes").textContent.split(" ").join(""),e=document.querySelector(".filters-categories").textContent.split(" ").join("_").replace("/","&"),s=document.querySelector(".filters-input").value,a={category:e,keyword:s,filterSearch:`by${t}`},r={category:e,keyword:s,filterSearch:`by${t}`,page:1,limit:9};return h.save("queryParams",r),a}function E(t){let e;switch(t){case"byAtoZ":e="byABC=true";break;case"byZtoA":e="byABC=false";break;case"byCheaperfirst":e="byPrice=true";break;case"byExpensivefirst":e="byPrice=false";break;case"byPopular":e="byPopularity=false";break;case"byNotpopular":e="byPopularity=true";break;default:e="byABC=true";break}return e}const A="https://food-boutique.b.goit.study/api/products";async function x(){return(await g.get("https://food-boutique.b.goit.study/api/products/categories")).data}async function F(t){let{keyword:e,category:s,page:a,limit:r,filterSearch:n}=t;const o=window.innerWidth;o<768?r=6:o>=768&&o<1440?r=8:r=9;const c=new URLSearchParams({page:a,limit:r});return e!==""&&c.append("keyword",e),s!==""&&s!=="Show_all"&&s!=="Categories"&&c.append("category",s),(await g.get(`${A}?${c}&${E(n)}`)).data}async function O(){return(await g.get("https://food-boutique.b.goit.study/api/products/discount")).data}async function R(){return(await g.get("https://food-boutique.b.goit.study/api/products/popular")).data}async function P(t){let e,{keyword:s,category:a,page:r=1,limit:n,filterSearch:o}=t;const c=window.innerWidth;c<768?n=6:c>=768&&c<1440?n=8:n=9;const i=new URLSearchParams({limit:n,page:r});return s!==""&&i.append("keyword",s),a!==""&&a!=="Show_all"&&a!=="Categories"&&i.append("category",a),e=await g.get(`${A}?${i}&${E(o)}`),e.data}async function $(t){return(await g.get(`https://food-boutique.b.goit.study/api/products/${t}`)).data}function N(t){let{img:e,name:s,category:a,size:r,popularity:n,price:o,_id:c,is10PercentOff:i}=t;const l=d.some(p=>p.id===c);return`
    ...
    `}const G=document.querySelector(".filters-form"),Z=document.querySelector(".filters-categories"),Y=document.querySelector(".filters-allTypes"),K=document.querySelectorAll(".filters-down-svg"),X=document.querySelectorAll(".filters-allTypes-item"),v=document.querySelector(".products-list-general"),tt=document.querySelector(".products-list-discount"),et=document.querySelector(".products-list-popular");let d=[];const st=()=>{const t=h.load("product");if(t===void 0){document.querySelector("#header-length").innerHTML="0";return}document.querySelector("#header-length").innerHTML=t.length,d=t};st();function at(){h.load("queryParams")||h.save("queryParams",{keyword:"",category:"",page:1,limit:9})}at();document.addEventListener("DOMContentLoaded",async()=>{try{const t=await x();I(t),document.querySelectorAll(".filters-categories-item").forEach(l=>{l.addEventListener("click",H)});const e=h.load("queryParams"),a=(await F(e)).results;y(a,"general",v),document.querySelectorAll(".product-card-general").forEach(l=>{l.addEventListener("click",f)});const n=await O();y(n,"discount",tt),document.querySelectorAll(".discount-product-card").forEach(l=>{l.addEventListener("click",f)});const c=await R();y(c,"popular",et),document.querySelectorAll(".popular-product-card").forEach(l=>{l.addEventListener("click",f),document.querySelectorAll(".js-addToCart-btn").forEach(m=>{m.addEventListener("click",k)})})}catch(t){console.log(t)}});Z.addEventListener("click",T);Y.addEventListener("click",T);K.forEach(t=>{t.addEventListener("click",z)});X.forEach(t=>{t.addEventListener("click",_)});G.addEventListener("submit",async t=>{t.preventDefault();try{const e=C(),a=(await P(e)).results;if(v.innerHTML="",a.length===0){const o=B();v.insertAdjacentHTML("beforeend",o)}else y(a,"general",v);document.querySelectorAll(".product-card-general").forEach(o=>{o.addEventListener("click",f)}),document.querySelectorAll(".js-addToCart-btn").forEach(o=>{o.addEventListener("click",k)})}catch(e){console.log(e)}});async function ot(t){const e={},s=t.currentTarget.getAttribute("data-id"),a=d.some(r=>r.id===s);if(!a){t.currentTarget.innerHTML=`Remove from <svg class="modal-btn-svg" width="18" height="18">
      ...
      </a>`,ellipsis:'<span class="tui-ico-ellip">...</span>',disabledMoveButton:`<span class="tui-page-btn tui-is-disabled tui-{{type}}">
      <span class="tui-ico-{{type}}">{{type}}>
      </span>
