import{s as x,i as u,g as w,l as v}from"./assets/footer-bf064eb8.js";import{a as g,P as H}from"./assets/vendor-d873ffc3.js";function _(e){const s=[...e,"Show all"].map(r=>`<li class="filters-categories-item" data-category="${r}">${r}</li>`);document.querySelector(".filters-categories-list").insertAdjacentHTML("beforeend",s.join("").replaceAll("_"," ")),console.log("Rendered Category List:",s)}function E(e){const t=this.closest(".filters-wrap"),s=t.querySelector(".filters-down-svg");t.querySelector("ul").classList.toggle("list-active"),s.classList.toggle("rotate")}function F(e){this.classList.toggle("rotate");const t=this.previousElementSibling;t.classList.contains("list-active")?t.classList.remove("list-active"):t.classList.add("list-active")}function T(){const e=document.querySelector(".filters-search-btn");e&&e.click()}function O(e){const t=document.querySelector(".filters-categories"),s=document.querySelector(".filters-categories-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T(),M(queryParameters)}function R(e){const t=document.querySelector(".filters-allTypes"),s=document.querySelector(".filters-allTypes-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T(),M(queryParameters)}function A(){const e=document.querySelector(".filters-allTypes").textContent.split(" ").join(""),s=document.querySelector(".filters-categories").textContent.trim(),a=s.toLowerCase()==="all"?"":s.split(" ").join("_").replace("/","&"),r=document.querySelector(".filters-input").value,n={category:a,keyword:r,filterSearch:`by${e}`},o={category:a,keyword:r,filterSearch:`by${e}`,page:1,limit:9};return x("queryParams",o),n}function B(e){let t;switch(e){case"byAtoZ":t="byABC=true";break;case"byZtoA":t="byABC=false";break;case"byCheaperfirst":t="byPrice=true";break;case"byExpensivefirst":t="byPrice=false";break;case"byPopular":t="byPopularity=false";break;case"byNotpopular":t="byPopularity=true";break;case"Show all":t="";break;default:t="byABC=true";break}return t}async function M(e){try{const t=await g.get(`${P}?${new URLSearchParams(e)}`);console.log("Server response:",t.data)}catch(t){console.error("Error making server request:",t)}}const P="https://food-boutique.b.goit.study/api/products";async function W(){return(await g.get("https://food-boutique.b.goit.study/api/products/categories")).data}async function N(e){let{keyword:t,category:s,page:a,limit:r,filterSearch:n}=e;const o=window.innerWidth;o<768?r=6:o>=768&&o<1440?r=8:r=9;const c=new URLSearchParams({page:a,limit:r});return t!==""&&c.append("keyword",t),s!==""&&s!=="Show_all"&&s!=="Categories"&&c.append("category",s),(await g.get(`${P}?${c}&${B(n)}`)).data}async function U(){return(await g.get("https://food-boutique.b.goit.study/api/products/discount")).data}async function V(){return(await g.get("https://food-boutique.b.goit.study/api/products/popular")).data}async function q(e){let t,{keyword:s,category:a,page:r=1,limit:n,filterSearch:o}=e;const c=window.innerWidth;c<768?n=6:c>=768&&c<1440?n=8:n=9;const i=new URLSearchParams({limit:n,page:r});return s!==""&&i.append("keyword",s),a!==""&&a!=="Show_all"&&a!=="Categories"&&i.append("category",a),t=await g.get(`${P}?${i}&${B(o)}`),t.data}async function C(e){return(await g.get(`https://food-boutique.b.goit.study/api/products/${e}`)).data}function J(e){let{img:t,name:s,category:a,size:r,popularity:n,price:o,_id:c,is10PercentOff:i}=e;const l=d.some(p=>p.id===c);return`
      ...
      `}async function f(e){if(e.target.closest(".js-addToCart-btn"))return;const a=e.target.closest("li").querySelector(".js-addToCart-btn").getAttribute("data-id"),r=await C(a);document.querySelector("body").insertAdjacentHTML("beforeend",K(r)),document.body.classList.add("is-overflow-hidden"),document.querySelector(".modal-btn-close").addEventListener("click",$),document.addEventListener("keydown",Z),document.addEventListener("click",Y),document.querySelector(".modal-product-btn-price").addEventListener("click",de)}async function k(e){const t=e.currentTarget.getAttribute("data-id");e.currentTarget.querySelector("use").setAttribute("href",`${u}#icon-checkmark`),e.currentTarget.setAttribute("disabled","true");const a={};try{const n=await C(t);console.log(n);const{category:o,size:c,_id:i,name:l,price:p,img:m}=n;a.category=o,a.size=c,a.id=i,a.name=l,a.price=p,a.img=m}catch(n){console.log(n)}const r=window.localStorage;d.push(a),r.setItem("product",JSON.stringify(d)),w()}function j(){return`
