import{i as u,g as L,l as v}from"./assets/footer-545a3304.js";import{a as g,P as x}from"./assets/vendor-d873ffc3.js";function F(e){const s=[...e,"Show all"].map(r=>`<li class="filters-categories-item" data-category="${r}">${r}</li>`);document.querySelector(".filters-categories-list").insertAdjacentHTML("beforeend",s.join("").replaceAll("_"," ")),console.log("Rendered Category List:",s)}function T(e){const t=this.closest(".filters-wrap"),s=t.querySelector(".filters-down-svg");t.querySelector("ul").classList.toggle("list-active"),s.classList.toggle("rotate")}function H(e){this.classList.toggle("rotate");const t=this.previousElementSibling;t.classList.contains("list-active")?t.classList.remove("list-active"):t.classList.add("list-active")}function A(){const e=document.querySelector(".filters-search-btn");e&&e.click()}function _(e){const t=document.querySelector(".filters-categories"),s=document.querySelector(".filters-categories-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),A(),M(queryParameters)}function O(e){const t=document.querySelector(".filters-allTypes"),s=document.querySelector(".filters-allTypes-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),A(),M(queryParameters)}function $(){const e=document.querySelector(".filters-allTypes").textContent.split(" ").join(""),s=document.querySelector(".filters-categories").textContent.trim(),a=s.toLowerCase()==="all"?"":s.split(" ").join("_").replace("/","&"),r=document.querySelector(".filters-input").value,n={category:a,keyword:r,filterSearch:`by${e}`};return(void 0)("queryParams",{category:a,keyword:r,filterSearch:`by${e}`,page:1,limit:9}),n}function B(e){let t;switch(e){case"byAtoZ":t="byABC=true";break;case"byZtoA":t="byABC=false";break;case"byCheaperfirst":t="byPrice=true";break;case"byExpensivefirst":t="byPrice=false";break;case"byPopular":t="byPopularity=false";break;case"byNotpopular":t="byPopularity=true";break;case"Show all":t="";break;default:t="byABC=true";break}return t}async function M(e){try{const t=await g.get(`${S}?${new URLSearchParams(e)}`);console.log("Server response:",t.data)}catch(t){console.error("Error making server request:",t)}}const S="https://food-boutique.b.goit.study/api/products";async function R(){return(await g.get("https://food-boutique.b.goit.study/api/products/categories")).data}async function W(e){let{keyword:t,category:s,page:a,limit:r,filterSearch:n}=e;const o=window.innerWidth;o<768?r=6:o>=768&&o<1440?r=8:r=9;const c=new URLSearchParams({page:a,limit:r});return t!==""&&c.append("keyword",t),s!==""&&s!=="Show_all"&&s!=="Categories"&&c.append("category",s),(await g.get(`${S}?${c}&${B(n)}`)).data}async function N(){return(await g.get("https://food-boutique.b.goit.study/api/products/discount")).data}async function U(){return(await g.get("https://food-boutique.b.goit.study/api/products/popular")).data}async function C(e){try{const{keyword:t,category:s,page:a=1,filterSearch:r}=e,n=V(),o=new URLSearchParams({limit:n,page:a});return t&&o.append("keyword",t),s&&s!=="Show_all"&&s!=="Categories"&&o.append("category",s),(await g.get(`${S}?${o}&${B(r)}`)).data}catch(t){throw console.error(t),t}}async function q(e){return(await g.get(`${S}/${e}`)).data}function V(){const e=window.innerWidth;return e<768?6:e<1440?8:9}function J(e){let{img:t,name:s,category:a,size:r,popularity:n,price:o,_id:c,is10PercentOff:i}=e;const l=d.some(p=>p.id===c);return`
  ...
  </li>`}function y(e,t,s){let a;t==="general"?a=e.map(r=>J(r)):t==="popular"?a=e.map(r=>Q(r)):a=e.map(r=>G(r)),s.innerHTML=a.join("")}function k(){const e=document.querySelector(".modal-product-backdrop");e.remove(),e.classList.add("is-hidden"),document.body.classList.remove("is-overflow-hidden")}function Z(e){const t=document.querySelector(".modal-product-backdrop");e.key==="Escape"&&(k(),t.classList.add("is-hidden"))}function Y(e){const t=document.querySelector(".modal-product-backdrop");e.target===t&&(k(),t.classList.remove("is-hidden"))}function K(e){let{name:t,category:s,desc:a,img:r,price:n,size:o,popularity:c,_id:i}=e;const l=d.some(p=>p.id===i);return`
      ...
      `}async function f(e){if(e.target.closest(".js-addToCart-btn"))return;const a=e.target.closest("li").querySelector(".js-addToCart-btn").getAttribute("data-id"),r=await q(a);document.querySelector("body").insertAdjacentHTML("beforeend",K(r)),document.body.classList.add("is-overflow-hidden"),document.querySelector(".modal-btn-close").addEventListener("click",k),document.addEventListener("keydown",Z),document.addEventListener("click",Y),document.querySelector(".modal-product-btn-price").addEventListener("click",de)}async function E(e){const t=e.currentTarget.getAttribute("data-id");e.currentTarget.querySelector("use").setAttribute("href",`${u}#icon-checkmark`),e.currentTarget.setAttribute("disabled","true");const a={};try{const n=await q(t);console.log(n);const{category:o,size:c,_id:i,name:l,price:p,img:m}=n;a.category=o,a.size=c,a.id=i,a.name=l,a.price=p,a.img=m}catch(n){console.log(n)}const r=window.localStorage;d.push(a),r.setItem("product",JSON.stringify(d)),L()}function j(){return`
