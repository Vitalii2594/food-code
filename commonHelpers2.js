import{s as x,i as u,g as L,l as v}from"./assets/footer-bf064eb8.js";import{a as g,P as H}from"./assets/vendor-d873ffc3.js";function _(e){const s=[...e,"Show all"].map(o=>`<li class="filters-categories-item" data-category="${o}">${o}</li>`);document.querySelector(".filters-categories-list").insertAdjacentHTML("beforeend",s.join("").replaceAll("_"," ")),console.log("Rendered Category List:",s)}function E(e){const t=this.closest(".filters-wrap"),s=t.querySelector(".filters-down-svg");t.querySelector("ul").classList.toggle("list-active"),s.classList.toggle("rotate")}function F(e){this.classList.toggle("rotate");const t=this.previousElementSibling;t.classList.contains("list-active")?t.classList.remove("list-active"):t.classList.add("list-active")}function T(){const e=document.querySelector(".filters-search-btn");e&&e.click()}function O(e){const t=document.querySelector(".filters-categories"),s=document.querySelector(".filters-categories-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T(),M(queryParameters)}function R(e){const t=document.querySelector(".filters-allTypes"),s=document.querySelector(".filters-allTypes-list"),a=e.target.textContent;t.textContent=a,s.classList.remove("list-active"),s.nextElementSibling.classList.remove("rotate"),T(),M(queryParameters)}function A(){const e=document.querySelector(".filters-allTypes").textContent.split(" ").join(""),s=document.querySelector(".filters-categories").textContent.trim(),a=s.toLowerCase()==="all"?"":s.split(" ").join("_").replace("/","&"),o=document.querySelector(".filters-input").value,n={category:a,keyword:o,filterSearch:`by${e}`},r={category:a,keyword:o,filterSearch:`by${e}`,page:1,limit:9};return x("queryParams",r),n}function B(e){let t;switch(e){case"byAtoZ":t="byABC=true";break;case"byZtoA":t="byABC=false";break;case"byCheaperfirst":t="byPrice=true";break;case"byExpensivefirst":t="byPrice=false";break;case"byPopular":t="byPopularity=false";break;case"byNotpopular":t="byPopularity=true";break;case"Show all":t="";break;default:t="byABC=true";break}return t}async function M(e){try{const t=await g.get(`${S}?${new URLSearchParams(e)}`);console.log("Server response:",t.data)}catch(t){console.error("Error making server request:",t)}}const S="https://food-boutique.b.goit.study/api/products";async function W(){return(await g.get("https://food-boutique.b.goit.study/api/products/categories")).data}async function N(e){let{keyword:t,category:s,page:a,limit:o,filterSearch:n}=e;const r=window.innerWidth;r<768?o=6:r>=768&&r<1440?o=8:o=9;const c=new URLSearchParams({page:a,limit:o});return t!==""&&c.append("keyword",t),s!==""&&s!=="Show_all"&&s!=="Categories"&&c.append("category",s),(await g.get(`${S}?${c}&${B(n)}`)).data}async function U(){return(await g.get("https://food-boutique.b.goit.study/api/products/discount")).data}async function V(){return(await g.get("https://food-boutique.b.goit.study/api/products/popular")).data}async function $(e){try{const{keyword:t,category:s,page:a=1,filterSearch:o}=e,n=J(),r=new URLSearchParams({limit:n,page:a});return t&&r.append("keyword",t),s&&s!=="Show_all"&&s!=="Categories"&&r.append("category",s),(await g.get(`${S}?${r}&${B(o)}`)).data}catch(t){throw console.error(t),t}}async function C(e){return(await g.get(`${S}/${e}`)).data}function J(){const e=window.innerWidth;return e<768?6:e<1440?8:9}function Q(e){let{img:t,name:s,category:a,size:o,popularity:n,price:r,_id:c,is10PercentOff:i}=e;const l=d.some(p=>p.id===c);return`
  ...
  </li>`}function y(e,t,s){let a;t==="general"?a=e.map(o=>Q(o)):t==="popular"?a=e.map(o=>G(o)):a=e.map(o=>Z(o)),s.innerHTML=a.join("")}function q(){const e=document.querySelector(".modal-product-backdrop");e.remove(),e.classList.add("is-hidden"),document.body.classList.remove("is-overflow-hidden")}function Y(e){const t=document.querySelector(".modal-product-backdrop");e.key==="Escape"&&(q(),t.classList.add("is-hidden"))}function K(e){const t=document.querySelector(".modal-product-backdrop");e.target===t&&(q(),t.classList.remove("is-hidden"))}function X(e){let{name:t,category:s,desc:a,img:o,price:n,size:r,popularity:c,_id:i}=e;const l=d.some(p=>p.id===i);return`
      ...
      `}async function f(e){if(e.target.closest(".js-addToCart-btn"))return;const a=e.target.closest("li").querySelector(".js-addToCart-btn").getAttribute("data-id"),o=await C(a);document.querySelector("body").insertAdjacentHTML("beforeend",X(o)),document.body.classList.add("is-overflow-hidden"),document.querySelector(".modal-btn-close").addEventListener("click",q),document.addEventListener("keydown",Y),document.addEventListener("click",K),document.querySelector(".modal-product-btn-price").addEventListener("click",ue)}async function k(e){const t=e.currentTarget.getAttribute("data-id");e.currentTarget.querySelector("use").setAttribute("href",`${u}#icon-checkmark`),e.currentTarget.setAttribute("disabled","true");const a={};try{const n=await C(t);console.log(n);const{category:r,size:c,_id:i,name:l,price:p,img:m}=n;a.category=r,a.size=c,a.id=i,a.name=l,a.price=p,a.img=m}catch(n){console.log(n)}const o=window.localStorage;d.push(a),o.setItem("product",JSON.stringify(d)),L()}function j(){return`
    ...
    `}const ee=document.querySelector(".filters-form"),te=document.querySelector(".filters-categories"),se=document.querySelector(".filters-allTypes"),ae=document.querySelectorAll(".filters-down-svg"),re=document.querySelectorAll(".filters-allTypes-item"),h=document.querySelector(".products-list-general"),oe=document.querySelector(".products-list-discount"),ce=document.querySelector(".products-list-popular");let d=[];const ne=()=>{const e=v.load("product");if(e===void 0){document.querySelector("#header-length").innerHTML="0";return}document.querySelector("#header-length").innerHTML=e.length,d=e};ne();function ie(){v.load("queryParams")||v.save("queryParams",{keyword:"",category:"",page:1,limit:9})}ie();document.addEventListener("DOMContentLoaded",async()=>{try{const e=await W();_(e),document.querySelectorAll(".filters-categories-item").forEach(l=>{l.addEventListener("click",O)});const t=v.load("queryParams"),a=(await N(t)).results;y(a,"general",h),document.querySelectorAll(".product-card-general").forEach(l=>{l.addEventListener("click",f)});const n=await U();y(n,"discount",oe),document.querySelectorAll(".discount-product-card").forEach(l=>{l.addEventListener("click",f)});const c=await V();y(c,"popular",ce),document.querySelectorAll(".popular-product-card").forEach(l=>{l.addEventListener("click",f),document.querySelectorAll(".js-addToCart-btn").forEach(m=>{m.addEventListener("click",k)})})}catch(e){console.log(e)}});te.addEventListener("click",E);se.addEventListener("click",E);ae.forEach(e=>{e.addEventListener("click",F)});re.forEach(e=>{e.addEventListener("click",R)});ee.addEventListener("submit",async e=>{e.preventDefault();try{const t=A(),a=(await $(t)).results;if(h.innerHTML="",a.length===0){const r=j();h.insertAdjacentHTML("beforeend",r)}else y(a,"general",h),le()&&await de(t);document.querySelectorAll(".product-card-general").forEach(r=>{r.addEventListener("click",f)}),document.querySelectorAll(".js-addToCart-btn").forEach(r=>{r.addEventListener("click",k)})}catch(t){console.log(t)}});function le(){return!0}async function de(e){try{console.log("Sending data to server:",e)}catch(t){console.error("Error sending data to server:",t)}}async function ue(e){const t={},s=e.currentTarget.getAttribute("data-id"),a=d.some(o=>o.id===s);if(!a){e.currentTarget.innerHTML=`Remove from <svg class="modal-btn-svg" width="18" height="18">
        ...
        </span>`,moreButton:'<a href="#"  class="tui-page-btn-el tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};return new H(P,e)};let b=D();window.addEventListener("resize",()=>{b=D()});const ge=async e=>{const t=e.page;console.log(t);try{const s=A();s.page=t;const o=(await $(s)).results;if(w.innerHTML="",o.length===0){const c=j();w.insertAdjacentHTML("beforeend",c)}else y(o,"general",w);document.querySelectorAll(".product-card-general").forEach(c=>{c.addEventListener("click",f)}),document.querySelectorAll(".js-addToCart-btn").forEach(c=>{c.addEventListener("click",k)})}catch(s){console.log(s)}};b.on("afterMove",ge);const I=async e=>{try{const t=await $(queryParameters);t.totalPages===1?P.classList.add("is-hidden"):(b.setTotalItems(t.totalPages),P.classList.remove("is-hidden")),b.reset()}catch(t){console.log(t)}};document.addEventListener("DOMContentLoaded",I);const me=document.querySelector(".filters-form");me.addEventListener("submit",I);document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".products-list-general");function t(){window.scrollY/(document.body.scrollHeight-window.innerHeight)*100>=30&&e.classList.add("animation")}window.addEventListener("scroll",t)});
